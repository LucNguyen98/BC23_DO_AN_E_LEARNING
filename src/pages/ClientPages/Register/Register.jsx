                                ...
                                <div className="signup-form">
                                    <div className="form-header">
                                        ...
                                        <p className="woocommerce-register">
                                            Already have an account? <a href="#" className="text-decoration-underline">Log in</a>
                                        </p>
                                    </div>
                                    <form method="post" className="woocommerce-form woocommerce-form-register register">
                                        <div className="row">
                                            ...
                                            <div className="col-xl-6">
                                                <p className="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                                    <label htmlFor='user-name'>User Name&nbsp;<span className="required">*</span></label>
                                                    <input type="text" className="form-control" name="user-name" defaultValue placeholder="Username" />
                                                </p>
                                            </div>
                                            <div className="col-xl-6">
                                                <p className="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                                    <label htmlFor='email'>Email&nbsp;<span className="required">*</span></label>
                                                    <input type="email" className="form-control" name="email" defaultValue placeholder="Your Email" />
                                                </p>
                                            </div>
                                            <div className="col-xl-6">
                                                <p className="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                            ...
                                            <div className="col-xl-6">
                                                <p className="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                                    <label htmlFor='re-password'>Re-Enter Password&nbsp;<span className="required">*</span></label>
                                                    <input type="password" className="form-control" name="re-password" defaultValue placeholder="Re-Enter Password" />
                                                </p>
                                            </div>
                                                ...
                                                <div className="d-flex align-items-center justify-content-between py-2">
                                                    <p className="form-row">
                                                        <label className="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__policy">
                                                            <input className="woocommerce-form__input woocommerce-form__input-checkbox" name="policy" type="checkbox" id="policy" defaultValue="forever" />
