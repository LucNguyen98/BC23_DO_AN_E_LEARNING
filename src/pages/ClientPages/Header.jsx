                                ...
                                <div className="header-contact text-center text-lg-start d-none d-sm-block">
                                    <ul className="list-inline">
                                        <li className="list-inline-item">
                                            <span className="text-color me-2"><i className="fa fa-phone-alt" /></span><a href="tel:+(354) 6800 37849"> +(354) 6800 37849</a>
                                        </li>
                                        <li className="list-inline-item">
                                            <span className="text-color me-2"><i className="fa fa-envelope" /></span><a href="malito:hello@edumel.com"> hello@edumel.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-6 col-md-12">
                                <div className="d-sm-flex justify-content-center justify-content-lg-end">
                                    ...
                                    <div className="header-btn text-center text-lg-end">
                                        <a href="#"> <i className="fa fa-user-alt" /> Login/Register</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <div className="offcanvas-icon d-block d-lg-none">
                                <a href="#" className="nav-toggler"><i className="fal fa-bars" /></a>
                            </div>
                            <div className="header-category-menu d-none d-xl-block">
                                <ul>
                                    <li className="has-submenu">
                                        <a href="#"><i className="fa fa-th me-2" />Categories</a>
                            ...
                            <div className="header-search-bar d-none d-xl-block ms-4">
                                <form action="#">
                                    ...
                                    <a href="#" className="search-submit"><i className="far fa-search" /></a>
                                </form>
                            </div>
