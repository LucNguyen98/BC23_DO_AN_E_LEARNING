                ...
                <div className="col-md-12 col-xl-6 col-lg-6">
                  <div className="banner-content ">
                    ...
                    <p className="mb-40">
                      ...
                      Dolores ullam libero magni reiciendis quam ipsa
                ...
                <div className="col-xl-4 col-lg-4">
                  <div className="text-center text-lg-end">
                    <a href="" className="btn btn-main-outline rounded">
                      All Instructors <i className="fa fa-angle-right" />
                    </a>
                  </div>
                </div>
              </div>
                      ...
                      <div className="testimonial-inner">
                        ...
                        <div className="client-info d-flex align-items-center">
                          <div className="client-img">
                            <img
                              src="/images/clients/testimonial-avata-01.jpg"
                              alt=""
                              className="img-fluid"
                            />
                          </div>
                    ...
                    <div className="testimonial-item">
                      <div className="testimonial-inner">
                        ...
                        <div className="client-info d-flex align-items-center">
                          <div className="client-img">
                            <img
                              src="/images/clients/testimonial-avata-02.jpg"
                              alt=""
                              className="img-fluid"
                            />
                          </div>
                    ...
                    <div className="testimonial-item">
                      <div className="testimonial-inner">
                        ...
                        <div className="client-info d-flex align-items-center">
                          <div className="client-img">
                            <img
                              src="/images/clients/testimonial-avata-03.jpg"
                              alt=""
                              className="img-fluid"
                            />
                          </div>
                    ...
                    <div className="testimonial-item">
                      <div className="testimonial-inner">
                        ...
                        <div className="client-info d-flex align-items-center">
                          <div className="client-img">
                            <img
                              src="/images/clients/testimonial-avata-04.jpg"
                              alt=""
                              className="img-fluid"
                            />
                          </div>
