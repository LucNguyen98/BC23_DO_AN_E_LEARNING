              ...
              <div className="col-lg-8 col-xl-8">
                <div className="title-block">
                  ...
                  <ul className="header-bradcrumb justify-content-center">
                    ...
                    <li className="active" aria-current="page">Blog Single</li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div className="post-single">
                  ...
                  <div className="single-post-content">
                    <div className="post-meta">
                      ...
                      <span className="post-date"><i className="fa fa-calendar-alt mr-2" />May 9, 2021</span>
                      <span className="post-comments"><i className="far fa-comments" />15 Comments</span>
                    </div>
                    <h3 className="post-title"> Digital Marketing Service Launched Ready Their Website Working Our
                      Site.</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, omnis voluptatum iure
                      expedita sequi obcaecati iste dolores debitis numquam, reprehenderit eum consequuntur
                    ...
                    <h4 className="inner-title">SEO is a Cost-Effective Advertising Strategy</h4>
                    <p>Some SEO-related tools such as the Google Keyword Planner and Google Analytics provide
                      ...
                      decide how to structure or revise your content. It also gives you insights on your
                      market’s behavior such as location, times of activity, frequency of searches,
                      technologies used, product preferences, etc. All these metrics are useful in helping you
                      get to know your audience.</p>
                    <ol>
                    ...
                    <h4 className="inner-title">SEO is a Cost-Effective Advertising Strategy</h4>
                    <p> It also gives you insights on your market’s behavior such as location, times of
                      activity, frequency of searches, technologies used, product preferences, etc. All these
                      metrics are useful in helping you get to know your audience.</p>
                    <ul>
                  ...
                  <div className="post-single-author mb-5">
                    ...
                    <div className="author-info">
                      ...
                      <p>Lorem ipsum dolor sit amet Officia enim nihil accusamus error perspiciatis nam quas
                        distinctio nobis, quibusdam mollitia totam ipsam obcaecati, iusto alias
                  ...
                  <div className="comments common-form">
                    ...
                    <div className="comment-box">
                      ...
                      <div className="comment-info">
                        ...
                        <a className="reply-link" href="#"><i className="fas fa-reply-all" />Reply</a>
                      </div>
                    </div>
                      ...
                      <div className="comment-box">
                        ...
                        <div className="comment-info">
                          ...
                          <p> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque
                            ante sollicitudin. Fusce condimentum nunc ac nisi vulputate fringilla. Donec
                  ...
                  <div className="comments-form common-form mt-4 ">
                    ...
                    <form action="#" className="comment_form">
                      <div className="row form-row">
                        ...
                        <div className="col-lg-12">
                          <div className="form-group">
                            <textarea name="msg" id="msgt" cols={30} rows={6} placeholder="Comment" className="form-control" defaultValue={""} />
                          </div>
                        </div>
                        <div className="col-lg-12">
                          <div className="form-group">
                            <a href="#" className="btn btn-main rounded">Post Comment</a>
                          </div>
                        </div>
                      </div>
                    </form>
                ...
                <div className="blog-sidebar mt-5 mt-lg-0">
                  <div className="widget widget-search">
                    <form role="search" className="search-form">
                      ...
                      <button type="submit" className="search-submit"><i className="fa fa-search" /></button>
                    </form>
                  </div>
                    ...
                    <div className="recent-posts">
                      <div className="single-latest-post">
                        <div className="widget-thumb">
                          <a href="blog-single.html"><img src={sm3} alt="" className="img-fluid" /></a>
                        </div>
                        <div className="widget-content">
                          <h5> <a href="blog-single.html">Custom Platform for an Audit Insurance</a></h5>
                          <span><i className="fa fa-calendar-times" />10 april 2021</span>
                        </div>
                      </div>
                      <div className="single-latest-post">
                        <div className="widget-thumb">
                          <a href="blog-single.html"><img src={sm2} alt="" className="img-fluid" /></a>
                        </div>
                        <div className="widget-content">
                  ...
                  <div className="widget widget_categories">
                    ...
                    <ul>
                      <li className="cat-item"><a href="#">Web Design</a>(4)</li>
                      <li className="cat-item"><a href="#">Wordpress</a>(14)</li>
                      <li className="cat-item"><a href="#">Marketing</a>(24)</li>
                      <li className="cat-item"><a href="#">Design &amp; dev</a>(6)</li>
                    </ul>
                  </div>
