                            ...
                            <div className="col-lg-8 col-xl-8">
                                <div className="title-block">
                                    ...
                                    <ul className="header-bradcrumb justify-content-center">
                                        ...
                                        <li className="active" aria-current="page">Instructors</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="team-item mb-5">
                                    ...
                                    <div className="team-content">
                                        ...
                                        <div className="course-meta">
                                            <span className="duration"><i className="far fa-user-alt" />20 Students</span>
                                            <span className="lessons"><i className="far fa-play-circle me-2" />2 Course</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
